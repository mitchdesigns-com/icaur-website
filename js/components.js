...
<nav class="nav" id="nav" role="navigation" aria-label="Main">
  <div class="nav__inner">
    <a href="/icaur-website/" class="nav__logo" aria-label="iCAUR home">
      <img src="/icaur-website/assets/images/icaur-logo.svg" alt="iCAUR" width="113" height="22" aria-hidden="true">
    </a>

    <ul class="nav__links" role="list">
      <li><a href="/icaur-website/about"    class="nav__link">About</a></li>
      <li class="nav__item--has-drop">
        <a href="/icaur-website/models/v27" class="nav__link nav__drop-trigger" aria-haspopup="true" aria-expanded="false">
          Models
        ...
        <div class="nav__dropdown" id="navModelsDropdown" role="region" aria-label="Models">
          <article class="mfc">
            <a href="/icaur-website/models/v27" class="mfc__inner" data-cursor-label="Explore">
              <span class="mfc__glow" aria-hidden="true"></span>
              <img src="/icaur-website/assets/images/v27-model-in-homepge-01.webp" alt="" class="mfc__img mfc__img--default" loading="lazy">
              <img src="/icaur-website/assets/images/v27-model-in-homepge-02.webp" alt="iCAUR V27" class="mfc__img mfc__img--hover" loading="lazy">
              <div class="mfc__bottom">
                <img src="/icaur-website/assets/images/V27-logo.svg" alt="iCAUR V27" class="mfc__logo">
          ...
          <article class="mfc">
            <a href="/icaur-website/models/v27" class="mfc__inner" data-cursor-label="Explore">
              <span class="mfc__glow" aria-hidden="true"></span>
              <img src="/icaur-website/assets/images/ot3-model-in-homepage-01.webp" alt="" class="mfc__img mfc__img--default" loading="lazy">
              <img src="/icaur-website/assets/images/ot3-model-in-homepage-02.webp" alt="iCAUR O3T" class="mfc__img mfc__img--hover" loading="lazy">
              <div class="mfc__bottom">
                <img src="/icaur-website/assets/images/T03-logo.svg" alt="iCAUR O3T" class="mfc__logo">
      ...
      <li class="nav__item--has-drop">
        <a href="/icaur-website/services" class="nav__link nav__drop-trigger" aria-haspopup="true" aria-expanded="false">
          Services
          <svg class="nav__drop-chevron" width="10" height="6" viewBox="0 0 10 6" fill="none" aria-hidden="true">
            <path d="M1 1l4 4 4-4" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/>
          </svg>
        ...
        <div class="nav__dropdown nav__dropdown--services" id="navServicesDropdown" role="region" aria-label="Services">
          <div class="nav__svc-links">
            <a href="/icaur-website/services/maintenance" class="nav__svc-link">Maintenance Schedules</a>
            <a href="/icaur-website/services/programs" class="nav__svc-link">Programs</a>
            <a href="/icaur-website/services/warranty" class="nav__svc-link">Warranty</a>
          </div>
          <a href="/icaur-website/services" class="nav__svc-media" data-cursor-label="Explore" aria-label="All services">
            <img src="/icaur-website/assets/images/Maintainance.webp" alt="iCAUR service &amp; maintenance" loading="lazy">
          </a>
        </div>
      </li>
      <li><a href="/icaur-website/innovation" class="nav__link">Innovation</a></li>
      <li><a href="/icaur-website/news"       class="nav__link">Media Center</a></li>
      <li><a href="/icaur-website/faq"        class="nav__link">FAQs</a></li>
      <li><a href="/icaur-website/contact"    class="nav__link">Contact Us</a></li>
    </ul>
    ...
    <div class="nav__actions">
      ...
      <a href="/icaur-website/reserve" class="btn btn--reserve btn--sm nav-btn-reserve">Reserve <span class="brand-name">iCAUR</span></a>
    </div>
  ...
  <div class="cmp-modal__panel">
    ...
    <div class="cmp-modal__grid">
      ...
      <div class="cmp-model-col">
        <div class="cmp-mfc">
          <img src="/icaur-website/assets/images/v27-model-in-homepge-01.webp" alt="iCAUR V27" class="cmp-mfc__img cmp-mfc__img--default">
          <img src="/icaur-website/assets/images/v27-model-in-homepge-02.webp" alt="iCAUR V27" class="cmp-mfc__img cmp-mfc__img--hover">
          <img src="/icaur-website/assets/images/V27-logo.svg" alt="" class="cmp-mfc__logo" aria-hidden="true">
      ...
      <div class="cmp-model-col">
        <div class="cmp-mfc">
          <img src="/icaur-website/assets/images/ot3-model-in-homepage-01.webp" alt="iCAUR O3T" class="cmp-mfc__img cmp-mfc__img--default">
          <img src="/icaur-website/assets/images/ot3-model-in-homepage-02.webp" alt="iCAUR O3T" class="cmp-mfc__img cmp-mfc__img--hover">
          <img src="/icaur-website/assets/images/T03-logo.svg" alt="" class="cmp-mfc__logo" aria-hidden="true">
          <div class="cmp-mfc__bottom">
...
<div class="mobile-menu" id="mobileMenu" aria-hidden="true">
  ...
  <nav class="mobile-menu__nav" aria-label="Mobile">
    <ul role="list">
      <li><a href="/icaur-website/about">About</a></li>
      <li class="mobile-menu__has-sub">
        <span class="mobile-menu__label" role="heading" aria-level="2">Models</span>
        <ul class="mobile-menu__sub" role="list">
          <li><a href="/icaur-website/models/v27">V27</a></li>
          <li><a href="/icaur-website/models/v27">O3T</a></li>
        </ul>
      </li>
      <li class="mobile-menu__has-sub">
        <span class="mobile-menu__label" role="heading" aria-level="2"><a href="/icaur-website/services">Services</a></span>
        <ul class="mobile-menu__sub" role="list">
          <li><a href="/icaur-website/services/maintenance">Maintenance Schedules</a></li>
          <li><a href="/icaur-website/services/programs">Programs</a></li>
          <li><a href="/icaur-website/services/warranty">Warranty</a></li>
        </ul>
      </li>
      <li><a href="/icaur-website/innovation">Innovation</a></li>
      <li><a href="/icaur-website/news">Media Center</a></li>
      <li><a href="/icaur-website/faq">FAQs</a></li>
      <li><a href="/icaur-website/contact">Contact Us</a></li>
    </ul>
  </nav>
  <div class="mobile-menu__actions">
    ...
    <a href="/icaur-website/reserve" class="btn btn--filled btn--lg">Reserve Your <span class="brand-name">iCAUR</span></a>
  </div>
</div>
`;
...
<footer class="footer" id="footer">
  ...
  <div class="footer__logo-wrap">
    <a href="/icaur-website/" aria-label="iCAUR home" class="footer__wordmark reveal reveal--logo" data-delay="0">
      <img src="/icaur-website/assets/images/icaur-logo.svg" alt="iCAUR" aria-hidden="true">
    </a>
  </div>
    ...
    <div class="footer__body">
      ...
      <div class="footer__body-left reveal reveal--up" data-delay="2">
        ...
        <div class="footer__models-big">
          <a href="/icaur-website/models/v27">V27</a>
          <a href="/icaur-website/models/o3t">O3T</a>
        </div>
        <nav class="footer__nav-row" aria-label="Footer navigation">
          <a href="/icaur-website/about">About</a>
          <a href="/icaur-website/services">Services</a>
          <a href="/icaur-website/innovation">Innovation</a>
          <a href="/icaur-website/news">Media Center</a>
          <a href="/icaur-website/faq">FAQs</a>
          <a href="/icaur-website/contact">Contact us</a>
        </nav>
        <a href="/icaur-website/reserve" class="btn btn--reserve btn--sm btn--arrow btn--magnetic">Reserve Your <span class="brand-name">iCAUR</span> <span class="arrow">→</span></a>
      </div>
      ...
      <div class="footer__body-right reveal reveal--up" data-delay="3">
        ...
        <p class="footer__nl-legal">By subscribing you agree to our <a href="/icaur-website/privacy">Privacy Policy</a> and consent to receive updates from iCAUR.</p>
        ...
        <div class="footer__partner">
          <img src="/icaur-website/assets/images/GBauto.webp" alt="Ghabour Auto" class="footer__ghabour-logo">
        </div>
...
<div class="footer__outro">
  <div class="footer__inner">
    <div class="footer__bottom">
      <p class="footer__legal">© 2026 iCAUR. All rights reserved. &nbsp;·&nbsp; <a href="/icaur-website/privacy">Privacy Policy</a> &nbsp;·&nbsp; <a href="/icaur-website/terms">Terms of Service</a></p>
...
<div id="quick-nav" class="qn" aria-label="Quick navigation">
  <div class="qn-menu" id="qnMenu" aria-hidden="true">
    ...
    <a href="/icaur-website/contact/?tab=maintenance" class="qn-item qn-item--maintenance" aria-label="Book Maintenance">
      <span class="qn-item-icon">
    ...
    <a href="/icaur-website/contact/?tab=test-drive" class="qn-item qn-item--drive" aria-label="Request Test Drive">
      <span class="qn-item-icon">
