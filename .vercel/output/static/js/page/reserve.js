...
(function () {
  ...
  if (form) {
    form.addEventListener('submit', function (e) {
      ...
      var payload = {
        requestType: 'reserve',
        firstName: data['rv-first'] || data.firstName || '',
        lastName: data['rv-last'] || data.lastName || '',
        email: data['rv-email'] || data.email || '',
        phone: data['rv-phone'] || data.phone || '',
        model: data['rv-model'] || data.model || '',
        showroom: data['rv-showroom'] || data.showroom || '',
